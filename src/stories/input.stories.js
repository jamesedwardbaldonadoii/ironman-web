...
export const Basic = () => '<div class="grid gap-3">' +
	...
	'<AppInput value="Text" label="Label" required> <app-icons name="moon" slot="before"/> </AppInput>' +
...
export const inputBeforeSlot = () => '<div class="grid grid-cols-3 gap-3 items-end">' +
	...
	'<AppInput value="Text" label="Label" required> <span slot="before"><app-icons name="moon" /> Test</span> </AppInput>' +
	'</div>';
export const inputAfterSlot = () => '<div class="grid grid-cols-3 gap-3 items-end">' +
	'<AppInput value="Text" label="Label" required> <app-icons name="moon" slot="after"/> </AppInput>' +
	'<AppInput value="Text" label="Label" required> <span slot="after">Test</span> </AppInput>' +
	'<AppInput value="Text" label="Label" required> <span class="flex" slot="after"><app-icons name="moon" /> Test</span> </AppInput>' +
	'</div>';
